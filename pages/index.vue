                ...
                <div class="review__slider">
                    <swiper :slides-per-view="3" :space-between="30" :breakpoints="breakpoints" :modules="modules"
                        ...
                        <swiper-slide class="slide">
                            <h2>Все лучшие преподаватели здесь</h2>
                            <p class="mb-0">
                                Эта платформа стала для меня настоящим открытием! Здесь так много разнообразных курсов на
                                самые разные темы. Я начала с курса по фотографии и была поражена качеством материалов и
                                профессионализмом инструкторов.
                            </p>
                            <div class="text-right">
                                <span>Дарья</span>
                            </div>
                        ...
                        <swiper-slide class="slide">
                            <h2>Теперь я могу воплощать свои идеи в жизнь</h2>
                            <p class="mb-0">
                                Очень довольна этой платформой! Я прошла курсы по маркетингу и созданию контента для
                                социальных сетей. Мне нравится, как важные аспекты подробно разбираются в уроках.
                            </p>
                            <div class="text-right">
                                <span>Ангелина</span>
                            </div>
                        ...
                        <swiper-slide class="slide">
                            <h2>Структурированные уроки</h2>
                            <p class="mb-0">
                                Выбор курсов на этой платформе просто огромен. Я прошел несколько курсов по веб-разработке и
                                программированию, и каждый раз был приятно удивлен качеством обучения.
                            </p>
                            <div class="text-right">
                                <span>Дмитрий</span>
                            </div>
                        ...
                        <swiper-slide class="slide">
                            <h2>Интересные курсы</h2>
                            <p class="mb-0">
                                Я нашла здесь множество интересных курсов, которые помогли мне расширить свои знания и
                                навыки. Обучение
                                на этой платформе - это настоящее удовольствие.
                            </p>
                            <div class="text-right">
                                <span>Елена</span>
                            </div>
                    ...
                    <div class="pcnext">
                        <img src="@/assets/img/prev.svg" class="prev" alt="" loading="lazy">
...
<script setup>
useSeoMeta({
    title: 'Главная | Studynow',
    ogTitle: 'Главная | Studynow',
    description: 'Главная | Studynow',
    ogDescription: 'Главная | Studynow',
})
</script>
...
section {
    ...
    @media (max-width: 1024px) {
        background: url('@/assets/img/bgmob.png') no-repeat;
        background-size: 100%;
    }
}
...
.main {
    ...
    .main__body {
        h1 {
            ...
            line-height: 130%;
            font-family: var(--int);
            background: linear-gradient(90deg, #462885 0.64%, #A021A7 52.97%);
            background-clip: text;
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        ...
        .searchbody {
            ...
            box-shadow: -38.66667px 38.66667px 38.66667px 0px rgba(255, 255, 255, 0.20) inset, 38.66667px -38.66667px 38.66667px 0px rgba(192, 182, 194, 0.20) inset;
